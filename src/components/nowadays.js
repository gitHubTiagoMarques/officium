  ...
  return (
    <section className={"row nowadays snap"}>
      <div className={"col-12 text-center"}>
        <h1 className={"titlecarro text-center nowadaystitle"}>
          Nowadays... It’s different
        </h1>
        <p className={"subnowadays text-center"}>
          It used to be that living in the cities was the best option for people
          looking for new job opportunities or to pursue a career in any new
          market, like tech.
        </p>
        <p className={"subnowadays text-center mb-0 mb-sm-5"}>
          But nowadays, it's different. Several factors made it that there are a
