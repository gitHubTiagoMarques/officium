...
class Carro extends Component {
    ...
    render(){
        ...
        <Carousel autoPlay  interval={4500} infiniteLoop className={"text-white snap showArrows={true} onChange={onChange} onClickItem={onClickItem} "}>
            {/* <div className={"carro carro1"}> */}
